function showMessage(message, category, animationIn = "animate__bounceIn", animationOut = "animate__fadeOut") {
    ...
    setTimeout(() => removeCurrentResponse(externalDiv, childDiv), 4 * 1000);
